<template>
    <div class="flex characterCard border-round-lg m-3">
      <div class="characterCard__ImgWrapper">
          <img :src="character.image" alt="poster" class="character-img md:w-14rem md:h-14rem border-round-left-md">
      </div>
      <div class="characterCard__ContentWrapper flex flex-column justify-content-around p-3">
          <section>
              <h2 class="text-xl md:text-3xl m-0">{{ character.name }}</h2>
          ...
          <section class="flex flex-column mt-2 mb-1">
              ...
              <p class="my-1 text-xs md:text-lg">{{ character.location.name }}</p>
          </section>
